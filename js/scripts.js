...
const createCharts = () => {
    ...
    _charts.vaccinatedAbs = createBasicChart(".data-box--vaccinated-abs .data-box_body");
    _charts.vaccinatedDay = createStackedColumnsChart(".data-box--vaccinated-day .data-box_body");
    _charts.vaccinatedDonut1 = createDonutChart(".data-box--vaccinated-1 .data-box_body");
    _charts.vaccinatedDonut2 = createDonutChart(".data-box--vaccinated-2 .data-box_body");
}
